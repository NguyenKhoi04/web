        ...
        <div className="space-y-6">
            ...
            {!loading && !error && orgs.length === 0 && (
                <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Chưa tham gia tổ chức nào</h3>
                    <p className="text-gray-500 mt-2 mb-6">Hãy tạo tổ chức đầu tiên của bạn để bắt đầu làm việc nhóm</p>
                    <button
                        onClick={() => setCreateOpen(true)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {orgs.map((org) => (
                    <div key={org.id} className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                        <div className="flex justify-between items-start mb-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <span className={`text-xs px-2 py-0.5 rounded-full ${org.role === 'OWNER' ? 'bg-yellow-100 text-yellow-800' :
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6 border-t border-b border-gray-100 py-4">
                            <div className="text-center">
                                <div className="text-xl font-bold text-gray-900">{org.memberCount}</div>
                                <div className="text-xs text-gray-500">Thành viên</div>
                            </div>
                            <div className="text-center border-l border-gray-100">
                                <div className="text-xl font-bold text-gray-900">{org.projectCount}</div>
