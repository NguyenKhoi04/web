...
export default function AssignTaskModal({
  ...
  const [pickedAssignees, setPickedAssignees] =
    useState<string[]>(defaultAssignees);
  const [followerId, setFollowerId] = useState<string | null>(
    defaultFollowerId,
  );
  ...
  async function submit() {
    try {
      ...
      const body: any = {};
      if (mode === "assignees" || mode === "both")
        body.assigneeIds = pickedAssignees;
