        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
                ...
                <div className="space-y-3">
                    <div>
                        <label className="mb-1 block text-sm font-medium">Tên Milestone <span className="text-red-500">*</span></label>
                        <input
                            value={title}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label className="mb-1 block text-sm font-medium">Ngày diễn ra (Deadline) <span className="text-red-500">*</span></label>
                            <input
                                type="date"
                                value={dueDate}
