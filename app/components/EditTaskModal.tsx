...
export default function EditTaskModal({
  ...
  async function loadTask() {
    try {
      ...
      // Attachments
      const existingFiles: AttachmentItem[] =
        data.attachments?.map((a: any) => ({
          ...
          preview:
            ...
            a.resource.mimeType?.startsWith("image/")
              ? `/uploads/${a.resource.objectKey}`
              : undefined, // Simple assumption for local uploads
        })) || [];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-2xl p-5 border border-gray-200">
                  ...
                  <label className="mt-4 block text-xs font-semibold text-gray-600 uppercase tracking-wide">
                    Mức ưu tiên
                  </label>
                  <select
                    value={priority}
