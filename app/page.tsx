...
<div className="hidden md:flex items-center space-x-4">
  ...
  <button className="cursor-pointer px-6 py-2 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
    Dùng thử miễn phí
  </button>
  <NotificationBell />
</div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="cursor-pointer group flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
              <Rocket className="w-5 h-5" />
              <span onClick={() => router.push('/dashboard')} className="font-semibold">Bắt đầu ngay</span>
              <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="flex items-center space-x-2 px-8 py-4 bg-white/20 backdrop-blur-md text-white border-2 border-white/30 rounded-full hover:bg-white/30 transition-all duration-300">
              <Play className="w-5 h-5 cursor-pointer" />
              <span className="font-semibold cursor-pointer">Xem demo</span>
            </button>
          </div>
        </div>
      </section>
