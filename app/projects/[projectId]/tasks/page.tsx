...
export default function ProjectTasksPage() {
  ...
  async function openHistory(taskId: string) {
    try {
      ...
      setHistoryErr(null);
      const res = await fetch(`/api/tasks/${taskId}/activity?limit=50`, {
        cache: "no-store",
      });
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">
                  Quản lý danh sách công việc dự án
                </p>
              </div>
            </div>
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M9 17V7m0 10a2 2 0 01-2 2H5m4-12a2 2 0 012-2h2a2 2 0 012 2v10a2 2 0 002 2h2"
                  />
                </svg>
                Mở Kanban
              </Link>
                  ...
                  {filteredItems.map((t) => {
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusStyle(t.status)}`}
                          >
                          ...
                          <div className="text-gray-900 text-sm">
                            {t.follower ? (
                              ...
                              <button
                                ...
                                onClick={() => {
                                  setAssignTask({ id: t.id, projectId });
                                  setAssignMode("follower");
                                  setAssignOpen(true);
                                }}
                              >
                                Giao người theo dõi
                        ...
                        <td className="px-3 py-4 text-right relative">
                          <div className="flex items-center gap-3 justify-end">
                            ...
                            {(() => {
                              ...
                              const isFollower =
                                t.follower?.id === session?.user?.id;

                              if (!isManager && !isAssignee && !isFollower)
                                return null;
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={1}
                              d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2"
                            />
                          </svg>
                          <div>
                            <p className="text-gray-500 font-medium">
                              Không có task theo bộ lọc
                            </p>
                            <p className="text-gray-400 text-sm">
                              Thử đổi điều kiện lọc hoặc tạo task mới
                            </p>
                          </div>
                        </div>
                      </td>
